...
import { Route, Truck, ShieldAlert, CheckCircle, Scale, Clock, Fuel, ArrowRight, FileText } from 'lucide-react';
import type { RouteComparison } from '../../types.ts';
...
export const LogisticsRouteView: React.FC<LogisticsRouteViewProps> = ({ onOpenGatePass }) => {
          ...
          <div>
            <div className="flex items-center justify-between pb-3 border-b border-outline-variant/20 text-xs font-label-micro">
              <span className="font-bold text-secondary-fixed flex items-center gap-1.5 text-sm">
                ...
                KRISHICLEAR DIRECT COLD-CHAIN VECTOR
              </span>
