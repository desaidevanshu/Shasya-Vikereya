    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', minWidth: 0, flex: 1, flexWrap: 'wrap' }}>
            <div style={{
              width: '34px',
              height: '34px',
              borderRadius: '10px',
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <div style={{
                ...
                <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#10b981', display: 'inline-block', boxShadow: '0 0 8px rgba(16,185,129,0.8)' }}></span>
                {modalLang === 'mr' ? 'मराठी / हिंदी / English' : modalLang === 'hi' ? 'हिंदी / मराठी / English' : 'Multilingual voice AI'}
              </div>
            </div>
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  color: viewMode === 'voice' ? '#07110d' : '#cbd5e1',
                  border: 'none',
                  borderRadius: '14px',
                  padding: '5px 10px',
                  fontSize: '0.72rem',
              ...
              >
                <Radio size={12} />
                {modalLang === 'mr' ? 'थेट व्हॉईस' : modalLang === 'hi' ? 'लाइव वॉइस' : 'Live Voice'}
              </button>
              <button
                onClick={() => {
                  stopSpeaking();
                ...
                style={{
                  background: viewMode === 'transcript' ? 'rgba(148, 163, 184, 0.12)' : 'transparent',
                  color: viewMode === 'transcript' ? '#f8fafc' : '#94a3b8',
                  border: 'none',
                  borderRadius: '14px',
                  padding: '5px 10px',
                  fontSize: '0.72rem',
              ...
              >
                ...
                {modalLang === 'mr' ? 'इतिहास' : modalLang === 'hi' ? 'इतिहास' : 'History'}
              </button>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0 }}>
            <button
              ...
              style={{
                ...
                gap: '5px',
                padding: '5px 9px',
                background: isMuted ? 'rgba(239, 68, 68, 0.12)' : 'rgba(16, 185, 129, 0.12)',
            ...
            >
              ...
              {modalLang === 'mr' ? 'सिस्टम' : modalLang === 'hi' ? 'सिस्टम' : 'System'}
            </button>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  background: modalLang === 'mr' ? '#10b981' : 'rgba(255, 255, 255, 0.04)',
                  color: modalLang === 'mr' ? '#05120d' : '#e2e8f0',
                  fontWeight: 700,
                  fontSize: '0.72rem',
                  padding: '5px 10px',
                  borderRadius: '12px',
                  border: modalLang === 'mr' ? '1px solid #10b981' : '1px solid rgba(255,255,255,0.08)',
                  cursor: 'pointer',
                  transition: 'all 0.2s ease'
                }}
              >
              ...
              <button
                ...
                style={{
                  background: modalLang === 'hi' ? '#10b981' : 'rgba(255, 255, 255, 0.04)',
                  color: modalLang === 'hi' ? '#05120d' : '#e2e8f0',
                  fontWeight: 700,
                  fontSize: '0.72rem',
                  padding: '5px 10px',
                  borderRadius: '12px',
                  border: modalLang === 'hi' ? '1px solid #10b981' : '1px solid rgba(255,255,255,0.08)',
                  cursor: 'pointer',
                  transition: 'all 0.2s ease'
                }}
              >
              ...
              <button
                ...
                style={{
                  background: modalLang === 'en' ? '#10b981' : 'rgba(255, 255, 255, 0.04)',
                  color: modalLang === 'en' ? '#05120d' : '#e2e8f0',
                  fontWeight: 700,
                  fontSize: '0.72rem',
                  padding: '5px 10px',
                  borderRadius: '12px',
                  border: modalLang === 'en' ? '1px solid #10b981' : '1px solid rgba(255,255,255,0.08)',
                  cursor: 'pointer',
                  transition: 'all 0.2s ease'
                }}
              >
            ...
            <div style={{
              ...
              color: isListening ? '#7dd3fc' : loading ? '#fbbf24' : isSpeaking ? '#6ee7b7' : '#cbd5e1',
              fontSize: '0.76rem',
              fontWeight: 700,
              textAlign: 'center'
            }}>
              <span style={{
                ...
                height: '8px',
                borderRadius: '50%',
                background: isListening ? '#38bdf8' : loading ? '#fbbf24' : isSpeaking ? '#10b981' : '#94a3b8',
                boxShadow: isListening ? '0 0 10px rgba(56,189,248,0.9)' : isSpeaking ? '0 0 10px rgba(16,185,129,0.8)' : 'none',
            ...
            <div style={{
              ...
              {(isListening || isSpeaking) && (
                <div style={{
                  ...
                  height: '195px',
                  borderRadius: '50%',
                  border: `1px solid ${isListening ? 'rgba(59,130,246,0.7)' : 'rgba(16,185,129,0.7)'}`,
                  animation: 'soft-breathe 2.2s ease-in-out infinite',
                  pointerEvents: 'none'
                }} />
              )}
              <div
                className={`voice-orb-container ${isListening ? 'voice-orb-active' : isSpeaking ? 'voice-orb-idle' : 'voice-orb-idle'}`}
                style={{
                  width: '150px',
                  height: '150px',
                  borderRadius: '50%',
                  background: isListening
                    ? 'linear-gradient(135deg, rgba(59,130,246,0.95), rgba(14,116,144,0.95))'
                    : isSpeaking
                    ? 'linear-gradient(135deg, rgba(16,185,129,0.92), rgba(18,110,90,0.96))'
                    : 'linear-gradient(135deg, rgba(16,185,129,0.85), rgba(16,185,129,0.7))',
                  color: '#eff6ff',
                  border: isListening ? '1px solid rgba(125,211,252,0.6)' : '1px solid rgba(110,231,183,0.4)',
                  boxShadow: isListening
                    ? '0 0 32px rgba(56, 189, 248, 0.35), inset 0 1px 0 rgba(255,255,255,0.18)'
                    : isSpeaking
                    ? '0 0 26px rgba(16,185,129,0.25), inset 0 1px 0 rgba(255,255,255,0.18)'
                    : '0 0 20px rgba(16,185,129,0.18), inset 0 1px 0 rgba(255,255,255,0.12)',
                  transition: 'all 0.2s ease',
                  cursor: 'pointer'
                }}
              ...
              >
                {(isListening || isSpeaking) ? (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                    {[1,2,3,4,5].map(i => (
                      <div key={i} style={{
                        ...
                        animation: `orb-wave ${0.45 + i * 0.08}s ease-in-out infinite alternate`,
                        height: `${10 + i * 9}px`,
                        opacity: 0.95
                      }} />
                    ))}
                  ...
                  <RefreshCw size={42} strokeWidth={2.4} />
                ) : (
            ...
            <div style={{ fontSize: '0.74rem', color: '#a8b7c9', textAlign: 'center', letterSpacing: '0.02em' }}>
              {isListening ? 'Listening to your voice' : loading ? 'Processing voice request' : isSpeaking ? 'Assistant is speaking' : 'Tap to speak with KrishiClear'}
            </div>
            ...
            <div style={{ maxWidth: '700px', width: '100%', display: 'flex', flexDirection: 'column', gap: '10px' }}>
              {lastFarmerText && (
                <div style={{
                  ...
                  <div style={{ fontSize: '0.82rem', color: '#dfeaf6', lineHeight: 1.6 }}>
                    <span style={{ color: '#6ee7b7', fontWeight: 700, marginRight: '6px' }}>{s.youAsked}</span>
                    "{lastFarmerText}"
                  </div>
                  <span style={{ fontSize: '0.68rem', color: '#94a3b8' }}>Groq Whisper &lt;150ms</span>
                </div>
              )}
              ...
              {lastAiResponse && (
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '2px' }}>
                    ...
                    <div>
                      <div style={{ fontSize: '0.78rem', fontWeight: 700, color: '#7ee7c2', letterSpacing: '0.02em' }}>किसान AI</div>
                      <div style={{ fontSize: '0.66rem', color: '#94a3b8' }}>Voice Assistant</div>
                    </div>
                  </div>
                  ...
                  <div style={{
                    ...
                    lineHeight: 1.7,
                    maxWidth: '620px',
                    fontFamily: 'Inter, "Devanagari Sangam MN", "Noto Sans Devanagari", sans-serif'
                  }}>
                    {cleanTextForSpeech(lastAiResponse)}
                  </div>

                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '8px', borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: '10px', flexWrap: 'wrap' }}>
                    <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                      ...
                      >
                        <Layers size={12} /> {s.viewCards}
                      </button>
                    </div>

                    <span style={{ fontSize: '0.68rem', color: '#a855f7' }}>Microsoft Neural Voice Active</span>
                  </div>
                </div>
              )}
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', marginTop: '8px' }}>
              <button
                ...
                style={{
                  ...
                  height: '86px',
                  borderRadius: '50%',
                  background: isListening ? '#2563eb' : loading ? '#f59e0b' : '#10b981',
                  color: '#f8fafc',
                  border: '1px solid rgba(255,255,255,0.08)',
                  cursor: 'pointer',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  boxShadow: isListening ? '0 0 35px rgba(59,130,246,0.5)' : '0 0 22px rgba(16,185,129,0.32)',
                  transition: 'all 0.2s ease'
                }}
                aria-label={isListening ? 'Stop listening' : 'Start listening'}
              >
                {isListening ? (
                  <Square size={30} fill="#ffffff" color="#ffffff" />
                ) : loading ? (
              ...
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: '0.76rem', color: isListening ? '#7dd3fc' : loading ? '#fbbf24' : '#6ee7b7', fontWeight: 800 }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '4px' }}>
                <span style={{ fontSize: '0.6rem', color: '#94a3b8', fontWeight: 700 }}>Speech recognition</span>
                <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: isListening ? '#38bdf8' : '#10b981' }} />
              </div>
              <div style={{ fontSize: '0.7rem', color: '#e2e8f0', fontWeight: 600 }}>{activeEngines.stt}</div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '4px' }}>
                <span style={{ fontSize: '0.6rem', color: '#94a3b8', fontWeight: 700 }}>Gemini reasoning</span>
                <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: loading ? '#fbbf24' : '#10b981' }} />
              </div>
              <div style={{ fontSize: '0.7rem', color: '#e2e8f0', fontWeight: 600 }}>{activeEngines.llm}</div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '4px' }}>
                <span style={{ fontSize: '0.6rem', color: '#94a3b8', fontWeight: 700 }}>Text-to-speech</span>
                <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: isSpeaking ? '#38bdf8' : '#10b981' }} />
              </div>
              <div style={{ fontSize: '0.7rem', color: '#e2e8f0', fontWeight: 600 }}>{activeEngines.tts}</div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '4px' }}>
                <span style={{ fontSize: '0.6rem', color: '#94a3b8', fontWeight: 700 }}>Traffic & logistics</span>
                <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: livekitStatus === 'connected' ? '#fbbf24' : '#f59e0b' }} />
              </div>
              <div style={{ fontSize: '0.7rem', color: '#f8fafc', fontWeight: 600 }}>{activeEngines.transport}</div>
            </div>

            <div style={{ marginTop: 'auto', paddingTop: '8px', borderTop: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#10b981' }} />
              <span style={{ fontSize: '0.65rem', color: '#6ee7b7', fontWeight: 700 }}>System ready</span>
            </div>
          </div>
        </div>
