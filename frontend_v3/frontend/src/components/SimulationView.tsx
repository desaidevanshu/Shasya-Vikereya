        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
              <span className="chip chip-cyan" style={{ fontSize: '0.7rem' }}>DIGITAL TWIN TELEMETRY</span>
              <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>Corridor Resilience & Shock Simulator</span>
            </div>
            <h1 style={{ fontSize: '1.35rem', fontWeight: 800, letterSpacing: '-0.02em', color: 'var(--text-primary)' }}>
              Supply Chain Multi-Shock Simulation Studio
            </h1>
          </div>
